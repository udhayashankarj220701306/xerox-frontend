export const TermsAndCondition = () => {
  return (
    <div>
      Terms &amp; Conditions This document is an electronic record in terms of
      ...
      any physical or digital signatures. This document is published in
      ...
      domain name https://xerox-frontend.onrender.com/ ('Website'), including
      the related mobile site and mobile application (hereinafter referred to as
      'Platform'). The Platform is owned by J UDHAYASHANKAR, a company
      incorporated under the Companies Act, 1956 with its registered office at
      No 43 252, Vivekanandhar road, Rajajipuram, Periyakuppam, Thiruvallur
      ,Tiruvallur ,India (hereinafter referred to as ?Platform Owner?, 'we',
      'us', 'our').. Your use of the Platform and services and tools are
      ...
      of updates.. For the purpose of these Terms of Use, wherever the context
      ...
      BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL
      THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE
      TERMS OF USE CAREFULLY BEFORE PROCEEDING.. The use of Platform and/or
      availing of our Services is subject to the following Terms of Use: To
      ...
      on the Platform.. Neither we nor any third parties provide any warranty or
      ...
      Platform is solely and entirely at your own risk and discretion for which
      ...
      graphics.. You acknowledge that unauthorized use of the Platform and/or
      the Services may lead to action against you as per these Terms of Use
      and/or applicable laws.. You agree to pay us the charges associated with
      availing the Services.. You agree not to use the Platform and/ or Services
      ...
      information.. You understand that upon initiating a transaction for
      availing the Services you are entering into a legally binding and
      enforceable contract with the Platform Owner for the Services.. You shall
      indemnify and hold harmless Platform Owner, its affiliates, group
      companies (as applicable) and their respective officers, directors,
      agents, and employees, from any claim or demand, or actions including
      reasonable attorney's fees, made by any third party or penalty imposed due
      to or arising out of Your breach of this Terms of Use, privacy Policy and
      other Policies, or Your violation of any law, rules or regulations or the
      rights (including infringement of intellectual property rights) of a third
      party. Notwithstanding anything contained in these Terms of Use, the
      parties shall not be liable for any failure to perform an obligation under
      these Terms if performance is prevented or delayed by a force majeure
      event.. These Terms and any dispute or claim relating to it, or its
      enforceability, shall be governed by and construed in accordance with the
      laws of India.. All disputes arising out of or in connection with these
      Terms shall be subject to the exclusive jurisdiction of the courts in
      Tiruvallur and Tamil Nadu. All concerns or communications relating to
